...
from events.models import Event, EventGeneralQuestions, AttendeeGeneralQuestions, Checkin
...
class EventCheckoutForm(forms.Form):
	...
	def __init__(self, event, cart, *args, **kwargs):
		...
		if general_questions.notes:
			self.fields["notes"] = forms.CharField(label="Notes", widget=forms.Textarea(attrs={"class":"validate-required", "rows": "4"}), required=general_questions.notes_required)
