...
from .views import EventLandingView, EventCreateView, ActiveEventsBackendListView, EventCheckoutView
...
urlpatterns = [
    ...
    path('active', ActiveEventsBackendListView.as_view(), name='active'),
