...
from .forms import FreeTicketForm, PaidTicketForm, DonationTicketForm
...
class TicketListView(OrganizationAccountMixin, ListView):
	model = Ticket
...
class TicketCreateView(OrganizationAccountMixin, CreateView):
	model = Ticket
	form_class = None
...
class TicketUpdateView(OrganizationAccountMixin, UpdateView):
	model = Ticket
	form_class = None
	template_name = "events/tickets/create_ticket.html"
